...
public class AsyncCommand : IAsyncCommand
{
	...
	private readonly Func<Func<Task>, Task>? _postAndPreExecute;
	...
	/// <param name="postAndPreExecute">Function to execute something before or/and after execution.</param>
	public AsyncCommand(Func<Task> execute,
		Func<object, bool>? canExecute = null,
		Action<Exception>? onException = null,
		bool continueOnCapturedContext = false,
		Func<Func<Task>, Task>? postAndPreExecute = null)
	{
		_postAndPreExecute = postAndPreExecute;
	...
	public Task ExecuteAsync() => _postAndPreExecute is not null ? _postAndPreExecute(_execute) : _execute();
