...
public partial class ExtendedValidatableEntry : ContentView
{
    ...
    #region ErrorMessage
    public static readonly BindableProperty ErrorMessageStyleProperty = BindableProperty.Create(nameof(ErrorMessageStyle), typeof(Style), typeof(ExtendedValidatableEntry), new Style(typeof(Label)) { }, propertyChanged: SetHeight);
    ...
    public static readonly BindableProperty ErrorMessageLinesProperty = BindableProperty.Create(nameof(ErrorMessageLines), typeof(int), typeof(ExtendedValidatableEntry), 1);
    ...
    public static readonly BindableProperty BorderStyleProperty = BindableProperty.Create(nameof(BorderStyle), typeof(Style), typeof(ExtendedValidatableEntry), null, propertyChanged:OnBorderStyleChanged);
    ...
    public static readonly BindableProperty InvalidStrokeBrushProperty = BindableProperty.Create(nameof(InvalidStrokeBrush), typeof(Color), typeof(ExtendedValidatableEntry), Color.FromRgb(212, 33, 33));
