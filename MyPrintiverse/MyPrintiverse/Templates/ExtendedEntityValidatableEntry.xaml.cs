...
public partial class ExtendedEntityValidatableEntry : ContentView
{
    ...
    #region ErrorMessage
    public static readonly BindableProperty ErrorMessageStyleProperty = BindableProperty.Create(nameof(ErrorMessageStyle), typeof(Style), typeof(ExtendedEntityValidatableEntry), new Style(typeof(Label)) { });
    ...
    public static readonly BindableProperty BorderStyleProperty = BindableProperty.Create(nameof(BorderStyle), typeof(Style), typeof(ExtendedEntityValidatableEntry), null);
